...
public class SwipeBack4Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swipe_back4_layout);

        grid_view = (GridView)findViewById(R.id.grid_view);
        swipe_back_layout = (SwipeBackLinearLayout)findViewById(R.id.swipe_back_layout);
        swipe_back_layout.setTouchView(grid_view);
        swipe_back_layout.setOnSwipeBackListener(new SwipeBackLinearLayout.OnSwipeBackListener() {
            ...
            public void onFinishActivity() {
                ...
                SwipeBack4Activity.this.finish();
            }
        });
