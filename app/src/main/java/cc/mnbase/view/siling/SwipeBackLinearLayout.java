...
public class SwipeBackLinearLayout extends LinearLayout implements View.OnTouchListener{
    ...
    private String tag = SwipeBackLinearLayout.class.getSimpleName();
    ...
    public SwipeBackLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
