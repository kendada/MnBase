...
import cc.mnbase.view.tab.weixin.WeiXinGroupTabLayout;
import cc.mnbase.view.tab.weixin.WeiXinTabLayout;
...
public class WeiXinTabActivity extends AppCompatActivity implements WeiXinGroupTabLayout.OnItemClickListener{

    private WeiXinGroupTabLayout group_tab_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        group_tab_layout = (WeiXinGroupTabLayout)findViewById(R.id.group_tab_layout);
    ...
    @Override
    public void onClick(int position, WeiXinTabLayout tabLayout) {
